...
**Vendor:** OpenAI  
**Lifecycle:** active  
**Current version in registry:** 0.16.0  
...
- **Embeddable SDK** (`supported`): JavaScript/TypeScript framework for building agent applications. Invocation: `See evidence`.
...
- **Embeddable SDK** (`native`): JavaScript/TypeScript framework for building agent applications. Invocation: `See evidence`.
...
- **Embeddable SDK** (`configurable`): JavaScript/TypeScript framework for building agent applications. Invocation: `See evidence`.
