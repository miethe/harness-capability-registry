...
**Vendor:** OpenAI  
**Lifecycle:** active  
**Current version in registry:** 7.5.0  
...
- **Embeddable SDK** (`supported`): Typed JavaScript/TypeScript access to the OpenAI API. Invocation: `See evidence`.
...
- **Embeddable SDK** (`native`): Typed JavaScript/TypeScript access to the OpenAI API. Invocation: `See evidence`.
...
- **Embeddable SDK** (`configurable`): Typed JavaScript/TypeScript access to the OpenAI API. Invocation: `See evidence`.
